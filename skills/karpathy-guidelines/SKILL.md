...
description: Behavioral guidelines to reduce common LLM coding mistakes. Use when writing code, editing existing code, or when the user asks for implementation, fixes, refactoring, or feature additions.
---
